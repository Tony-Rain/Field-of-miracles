    ...
    if admin_id is not None:
        if message.chat.username is None:
            bot.send_message(admin_id,
                             'Зарегистрирован новый пользователь под ником' + message.chat.first_name + ' ' + message.chat.last_name)
        else:
            bot.send_message(admin_id,
                             'Зарегистрирован новый пользователь с username ' + '@' + (message.chat.username))
